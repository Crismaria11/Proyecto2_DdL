...
def charToAutomata(charactrers):
    ...
    for c in charactrers:
        ...
        toparse = ""
        flagerino = False
        # mientras i sea menor a lo que contenga la lista del id del charac
        while i < len(charactrers[c]):
            if charactrers[c][i] == '"' or charactrers[c][i] == "'":
                # Se agrega un parentesis de cierre o para abrir
                ...
                # Si encuentro un + agrego |
            elif charactrers[c][i] == "+":
                toparse += "|"
                # lo que se lee temporal mas lo que este en la lista de
                # caracteres, se agrega lo que ya se tiene a la lista
        ...
        # devuevlve una linea con los tokens
